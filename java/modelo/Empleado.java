...
public class Empleado extends Persona {
    ...
    try{
        cn = new Conexion();
        cn.abrir_conexion();
        String query = "SELECT e.id_empleados as id,e.codigo,e.nombres,e.apellidos,e.direccion,e.telefono,e.fecha_nacimiento,p.puestos FROM  empleados as e inner join puestos as p on e.di_puesto = p.id_puestos; ";
